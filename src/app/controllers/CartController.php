...
class CartController {
    ...
    public function render($request, $response, $args) {
        ...
        return $this->container->renderer->render($response, "cart.view.php", compact('title', "header", "checkout", 'withCategories', 'productos', 'repositorio'));
    }
